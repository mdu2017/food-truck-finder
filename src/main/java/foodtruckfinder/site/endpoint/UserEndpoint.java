...
public class UserEndpoint {
	...
	@PostMapping(value = "/setPreferences", produces = "application/json")
	public void setPreferences(List<FoodTruckDto.FoodType> types, Long user_ID){
		userService.setPrefFoodTypes(types, user_ID);
		return;
	}
