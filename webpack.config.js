...
let main = 'js/app.js';
let libraryName = 'food-truck-finder-site';
let outputFile = '';
let port = 3000;
...
const config = {
	...
	module: {
		rules: [{
				test: /\.js$/,
				use: [ 'babel-loader' ],
				exclude: [/node_modules/, /nodejs/, /npm/]
			}, {
...
config.module.rules.push({ test: /\.js?$/, loader: 'eslint-loader', exclude: [/node_modules/, /nodejs/, /npm/] });
